 ...
 */
public class ZlxNationFragment extends BaseViewPagerFragment implements com.example.ylf019.zlxandroid.home.adapter.ZLXWeiboListAdapter.onItemViewClick {
...
//        ZLXWeiboListAdapter.addHeaderView(initHeadView());
    ...
    private void onDataRefresh() {
        ...
        netHandler.findUserList(page +"", "10", mSharedPreferencesHelper.getString(AppSpContact.SP_KEY_LOGIN_AREA),
                mSharedPreferencesHelper.getString(AppSpContact.SP_KEY_LX_NUM), "民风民俗", new MyCallBack<List<WeiboInfo>>() {
            @Override
