 ...
 */
public class ZlxHelpItemFragment extends BaseViewPagerFragment implements com.example.ylf019.zlxandroid.home.adapter.ZLXWeiboListAdapter.onItemViewClick {
...
//    ImageView         mIvFashuoshuo;
    ...
    protected int getLayoutResId() {
        return R.layout.fragment_zlx_help_item;
    }
...
//        ZLXWeiboListAdapter.addHeaderView(initHeadView());
    ...
    private void onDataRefresh() {
        page = 0;
        netHandler.findUserList(page +"", "10", "上海市", mSharedPreferencesHelper.getString(AppSpContact.SP_KEY_LX_NUM), "求助", new MyCallBack<List<WeiboInfo>>() {
            @Override
    ...
    private void onDataMore() {
        page++;
        netHandler.findUserList(page +"", "5", "上海市", mSharedPreferencesHelper.getString(AppSpContact.SP_KEY_LX_NUM), "求助", new MyCallBack<List<WeiboInfo>>() {
            @Override
            public void onFailure(Call call, IOException e) {
                Toast.makeText(mContext,"请求失败,请重试", Toast.LENGTH_SHORT).show();
            }
