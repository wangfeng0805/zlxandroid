...
//                params.clear();
            ...
            public void run() {
                ...
                if (myCallBack.type == String.class) {
                    ...
                    try {
                        ...
                        Log.e("返回json数据",json);
                        myCallBack.onSuccess(call, null);
                    }
                }
            }
        });
    ...
    public void loadImage(String url, File file, Map<String, String> maps, MyCallBack myCallBack) {
        doRequest(getFileRequest(url, file, maps),myCallBack);
    }
