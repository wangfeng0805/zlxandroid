...
import com.example.ylf019.zlxandroid.zlxadvert.ZlxAdvertItemFragment;
import com.example.ylf019.zlxandroid.zlxadvert.ZlxHelpItemFragment;
 ...
 */
public class ZlxadvertFragment extends BaseFragment {
    ...
    private ZlxAdvertItemFragment mZlxAdvertItemFragment;
    private ZlxHelpItemFragment   mZlxHelpItemFragment;
...
//            magicIndicator.setBackgroundResource(R.color.rng_black);
    ...
    private void initViewPager() {
        ...
        mViewPager.setAdapter(pagerAdapter);
        mDataList = Arrays.asList(getResources().getStringArray(R.array.ZLX_advert_titles));
...
//                linePagerIndicator.setColors(getResources().getColor(R.color.color_tab));
    ...
    private void initFragments() {
        fragments.clear();
        if (mZlxAdvertItemFragment == null)
            mZlxAdvertItemFragment = new ZlxAdvertItemFragment();
        fragments.add(mZlxAdvertItemFragment);
        if (mZlxHelpItemFragment == null)
            mZlxHelpItemFragment = new ZlxHelpItemFragment();
        fragments.add(mZlxHelpItemFragment);
    }
