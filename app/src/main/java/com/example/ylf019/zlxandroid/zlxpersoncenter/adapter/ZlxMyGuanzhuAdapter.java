...
public class ZlxMyGuanzhuAdapter extends BaseQuickAdapter<ZlxMyFansModel.InfoBean, BaseViewHolder> {

    private OnLikeInterface mOnLikeInterface;
    private boolean mIsfollowNotShow = false;

    public ZlxMyGuanzhuAdapter(@LayoutRes int layoutResId, @Nullable List<ZlxMyFansModel.InfoBean> data) {
...
//        TextView tv_content = helper.getView(R.id.tv_content);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(mOnLikeInterface != null) {
                    mOnLikeInterface.onCancelFans(helper.getPosition(), item.getId());
                }
            }
        });
    ...
    public interface OnLikeInterface {
        ...
        void onCancelFans(int position, String id);
    }
